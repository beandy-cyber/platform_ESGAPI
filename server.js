...
app.get('/articles', (req, res) => {
  const articles = [
	{ id: 1, title: 'Sustentabilidade Ambienta', content: 'Preservar o planeta é nossa responsabilidade coletiva. Adotar energias renováveis e reduzir resíduos são passos vitais para um futuro sustentável' },
